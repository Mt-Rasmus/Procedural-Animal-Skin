...
attribute float vD2_x;
attribute float vD2_y;
attribute float vD2_z;
uniform float delta;
...
//    p.x += sin(vertexDisplacement) * 1.0 + 10.0*vD2_x;
//    p.y += cos(vertexDisplacement) * 1.0 + 10.0*vD2_x;
//    p.z += cos(vertexDisplacement) * 1.0 + 10.0*vD2_x;
